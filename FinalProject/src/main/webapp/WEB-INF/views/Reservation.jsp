...
<meta name="generator" content="Hugo 0.142.2">
		...
		<div class="container">
			<div class="row" id="room">
				<div class="col-md-6 mb-4" align="center">
					<div>
						<img class="img-fluid" src="resources/img/res_party1.png">
					</div>
					<div>
						<button>
							<a href="ARoom.html">A Room</a>
						</button>
					</div>
				</div>
				<div class="col-md-6 mb-4" align="center">

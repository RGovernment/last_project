...
<body>
	<main>
		<div class="container-fluid mb-0" id="nav-bg">
			<header class="d-flex flex-wrap justify-content-center pb-0 mb-0">
				<div class="row">
		...
		<div class="container-fluid mt-0 mb-0" id="main-bg">
			<div class="container mt-0 mb-0">
				<div class="d-flex align-items-center justify-content-center"
					id="main-text">평생 잊지 못할 단 하나뿐인 하루를 선사해드립니다.</div>
			</div>
			<br> <br>
		</div>
		<div class="container">
			<div class="row" id="txt">
				<div class="col-md-12 align-self-center">
					<p id="title-text2">Single Service 단품 서비스
					</p>
					<p id="mobile-text1">(PC에서 자세히 확인)
					</p>
				</div>
				<br>
			</div>
			...
			<div class="row" id="table-con">
				...
				<div class="col-md-4 align-self-center">풍선 및 룸 데코레이션 : 5만원
					플랜카드 제작 : 3만원 세트 : 7만원</div>
				<div class="col-md-4 align-self-center">풍선 및 데코레이션 스타일 A/B/C중
					택1 플랜카드 제작시 문구 및 사진인쇄 가능</div>
			</div>
			<div class="row" id="table-con">
				<div class="col-md-4 align-self-center">케이크</div>
				<div class="col-md-4 align-self-center">레터링 케이크 : 5만원 얼굴 인화
					케이크 : 7만원</div>
			...
			<div class="row" id="table-con">
				...
				<div class="col-md-4 align-self-center">콜라/사이다/환타 : 1200원 물 :
					1000원 소주 : 1600원 / 맥주 : 2000원 / 양주 : 문의</div>
				<div class="col-md-4 align-self-center">파티 시작시 바로 시원하게 즐기실 수
					있도록 미리 시원한 주류들을 냉장 보관 및 아이스박스 보관해드립니다!</div>
			</div>
			...
			<div class="row" id="table2-con">
				...
				<div class="col-4 align-self-center">풍선 및 룸 데코레이션 플랜카드 제작 세트</div>
				<div class="col-4 align-self-center">풍선 데코 스타일 A/B/C 택1 플랜카드
					제작시 문구 +사진인쇄 O</div>
			</div>
			<div class="row" id="table2-con">
				<div class="col-4 align-self-center">케이크</div>
				<div class="col-4 align-self-center">레터링 케이크 얼굴 인화 케이크</div>
				<div class="col-4 align-self-center">최고 품질 수제 케이크 초코/생크림 택1</div>
			</div>
			<div class="row" id="table2-con">
		...
		<div class="container">
			<div class="row" id="txt">
				<div class="col-md-12 align-self-center">
					<p id="title-text2">Package Service 패키지 서비스
					</p>
				</div>
				<br>
			</div>
			...
			<div class="row" id="table-con">
				...
				<div class="col-md-4 align-self-center">포토스냅B + 파티룸 데코레이션 세트 +
					얼굴인화 케이크</div>
			</div>
			<div class="row" id="table-con">
			...
			<div class="row" id="table2-con">
				...
				<div class="col-4 align-self-center">포토스냅B + 파티룸 데코레이션 세트 +
					얼굴인화 케이크</div>
			</div>
			<div class="row" id="table2-con">
